...
public class SingleLine
{
    ...
    {
        Directory.SetCurrentDirectory(@"D:\Google Drive\_Ryan\Code\C#\AOC\AOC\Y2023\inputs");
        Console.WriteLine(string.Join('\n', new List<string>()
        {
            ...
            "03.2: " +
                new Func<string, Dictionary<int, string>, long>((str, matches) =>
                    ...
                    Regex.Matches(new string('.', 141) + string.Join('.', File.ReadAllLines("input3.txt")) + new string('.', 141), "[0-9]+")
